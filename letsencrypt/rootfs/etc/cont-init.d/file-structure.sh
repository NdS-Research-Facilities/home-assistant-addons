...
echo -e "dns_desec_token = $(bashio::config 'dns.desec_token')\n" \
      ...
      "dns_acmedns_endpoint = $(bashio::config 'dns.easydns_endpoint')\n" \
      "dns_acmedns_usertoken = $(bashio::config 'dns.easydns_token')\n" \
      "dns_acmedns_userkey = $(bashio::config 'dns.easydns_key')\n" > /data/dnsapikey
